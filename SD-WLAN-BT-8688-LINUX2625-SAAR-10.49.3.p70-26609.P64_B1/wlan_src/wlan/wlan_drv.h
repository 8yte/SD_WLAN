...
#define DRIVER_RELEASE_VERSION		"24609.p64"
#endif
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,0)
#define DRIVER_RELEASE_VERSION		"26609.p64"
#endif
...
/** Data structure for wapi key set */
typedef struct
{
    /** unicast key */
    wapi_key Wapi_uni_key;
    /** group key */
    wapi_key Wapi_grp_key;
    /** WAPI Tx PN */
    u32 WAPI_TxPN[4];
} wapi_key_set;
#endif
...
#ifdef WAPI_DRIVER
    /** current wapi key */
    wapi_key_set cur_wapi_key;
    /** old wapi key */
    wapi_key_set old_wapi_key;
    /** fragment skb */
